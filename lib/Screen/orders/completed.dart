            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  Text(
                    "Completed Past orders will Appear here",
                      ...
                      return Column(
                        children: [
                          dataSnapshot.data!.docs[i]['sp_id'] ==
                              ...
                              ? dataSnapshot.data!.docs[i]['order_status'] ==
                                          "5" ||
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          dataSnapshot
                                                                              .data!
                                                                              .docs[i]['order_item'][j]['order_itemtitle'],
                                                                          style: TextStyle(
                                                                              color: tyrianPurple,
                                                            ...
                                                            Padding(
                                                              padding:
                                                                  const EdgeInsets
                                                                      ...
                                                                      top: 8.0),
                                                              child: Text(
                                                                "\$${dataSnapshot.data!.docs[i]['order_totalprice']}",
                                                                style: TextStyle(
                                                                    fontSize:
                                                                        15.0),
                                                              ),
